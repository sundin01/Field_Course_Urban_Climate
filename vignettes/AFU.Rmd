...
box_2m_day <- boxplot_creater(AFU_combined, Anomaly_old_log_ref, colnbr = 7, whole = FALSE,
...
densityplot_creater(AFU_combined, Anomaly_new_log_ref, colnbr = 6, whole = FALSE, title = c("Hallo"), 
                    subtitle = c("23.3.4567"), xlab = c("x-Achse"), ylab = c("y-Achse"))

# Densityplot old logger - reference station at AFU (daytime)
density_2m_day <- densityplot_creater(AFU_combined, Anomaly_old_log_ref, colnbr = 7, whole = FALSE,
...
##########################################################################################################
# generate latex code
xtable(afu_24, align = c('l', rep('c', times = 11)))
xtable(afu_daytime, align = c('l', rep('c', times = 11)))
xtable(afu_nighttime, align = c('l', rep('c', times = 11)))
```
